                ...
                <div>
                    <div className="footer-head row pt-4">
                        <div className="col-12 footer-col footer-head-col text-center">
                            <div className="footer-h2 text-center"><b>AGROKART</b></div>
                        ...
                        <div className="col-12 footer-col footer-head-col mt-4 text-center mb-3">
                            ...
                            <div className="footer-head-div-2 footer-text-font-mobile mt-0"><Link className="cs-links" to="">Contact Us</Link></div>
                            <div className="footer-head-div-2 footer-text-font-mobile"><Link className="cs-links" to="">Customer Service</Link></div>
                            <div className="footer-head-div-2 footer-text-font-mobile"><Link className="cs-links" to="">FAQs</Link></div>
                            <div className="footer-head-div-2 footer-text-font-mobile"><Link className="cs-links" to="">Order & Returns</Link></div>
                            <div className="footer-head-div-2 footer-text-font-mobile"><Link className="cs-links" to="">Consultancy</Link></div>
                        </div>
                    </div>
                    ...
                    <div className="footer-base row">
                        <div className="footer-lower-left col footer-text-font text-center">©2023 AgroKart. All rights reserved</div>
                    </div>
                </div>
            </footer>
        );
                ...
                <div>
                    <div className="footer-head row">
                        <div className="col-md-4 col-sm-6 footer-col footer-head-col">
                            <div className="footer-h2"><b>AGROKART</b></div>
                            <p class="footer-text-font">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede. Donec nec justo eget felis facilisis fermentum.</p>
                            <div className="mt-3">
                                <span className="footer-social-media-icons"><Link className="sm-icons-links" to=""><BsFacebook/></Link></span>
                                <span className="footer-social-media-icons"><Link className="sm-icons-links" to=""><BsLinkedin/></Link></span>
