...
function Rent(){
  ...
  const handleSubmit=async (e)=>{
    ...
    <form><div className="flexb">
      ...
      <input type="text" id="item-name" name="name" required onChange={(e)=>{
        setName(e.target.value);
        }}/></div>
      <div className="flexb">
      <label for="item-address">Your Address :</label>
      <input type="text" id="item-address" name="address" required onChange={(e)=>{
        setAddress(e.target.value);
        }}
      /></div>
      <div className="flexb">
      <label for="item-service">Service Required :</label>
      <input type="text" id="item-service" name="service" required onChange={(e)=>{
        setService(e.target.value);
      }}
      /></div>
      <div className="flexb">
      <label for="item-date">From :</label>
      <input type="date" id="item-date" name="date" required onChange={(e)=>{
        setDate(e.target.value);
      }}/></div>
      <div className="flexb">
      <label for="item-Duration">Duration(in days) :</label>
      <input type="number" id="item-Duration" name="duration" required onChange={(e)=>{
        setDuration(e.target.value);
      }}/></div>
      <div className="flexb">
      <label for="item-area">Area of Land (in acre):</label>
      <input type="number" id="item-area" name="area" required onChange={(e)=>{
        setArea(e.target.value);
      }}/></div>

      <div className="flexb"><label for="item-price">Item Fare per week:</label>
      <input type="text" id="item-price" name="price" required onChange={(e)=>{
