    ...
    return (
        <div class="row">
            ...
            <div class="col-5" style={{paddingRight:"1.7%", paddingLeft:"1.7%"}}>
                ...
                <div class="row my-2">
                    <div>Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. Nulla porttitor accumsan tincidunt. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec rutrum congue leo eget malesuada.</div>
                </div>
                <div class="row my-2">
