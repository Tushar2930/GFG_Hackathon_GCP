...
function SingleProduct(){
  ...
  <div class="w-screen container px-5 py-24 mx-auto" style={{width:"100vw"}}>
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={data.ip} />
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 class="text-sm title-font text-gray-500 tracking-widest uppercase">{data.category}</h2>
        <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">{data.species} {data.product}</h1>
        <div class="flex mb-4">
        ...
        <div class="flex">
          <span class="title-font font-medium text-2xl text-gray-900">₹ {data.price*temp}</span>
