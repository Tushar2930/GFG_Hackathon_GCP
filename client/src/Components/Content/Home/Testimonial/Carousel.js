...
function DemoCarousel() {
        return (
            <Carousel infiniteLoop={true} autoPlay="true" width="60%" height="50%" showIndicators={false} showArrows={false}>
              ...
              <p className='test-text'>Dramatically maintain clicks-and-mortar solutions without functional solutions. Completely synergize resource taxing relationships via premier niche markets. Professionally cultivate.</p>
              </div>
                </div>
